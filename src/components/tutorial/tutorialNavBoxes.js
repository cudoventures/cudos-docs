...
const FeatureList = [
  {
    ...
    icon: 'https://docs.cudos.org/docs/build/tutorials/img/rocket.png',
    items: [
      {
  ...
  },
  {
    ...
    icon: 'https://docs.cudos.org/docs/build/tutorials/img/messaging.svg',
    items: [
  ...
  },
  {
    ...
    icon: 'https://docs.cudos.org/docs/build/tutorials/img/nft.svg',
    items: [
