...
**Validator nodes** should not be run without being protected by a [**Sentry node architecture**](sentry-node-arch)

:::

It follows on from the [build environment](build-envt) which is a prerequisite for this step. 
