...
The process is the same as for any other VM, except that you need to select the private network that you want in the drop down menu of the Networking box.
...
Alternatively, you could set up a reverse SSH proxy, where the VM dials out to a jump box you already have on the outside.
