...
:::note
The referral system is currently only for infrastructure usage. Inference will be added into the referral system soon.
:::

You can find the referral section in the profile drop down, at the top right of the page.

![asic-referral-overview](@site/static/img/asic-referral-overview.png)
...
For example, if your referral link is `https://asicloud.cudos.org/?referrer=sample-referral-code-314159`, then your referral code would be `sample-referral-code-314159`.
...
![asic-referral-history](@site/static/img/asic-referral-history.png)
